...
public TableroPersonalizado(int filas, int columnas, int numeroDeBombasParaPoner) throws IllegalArgumentException {
	...
	for (int i = 0; i < numeroDeBombasParaPoner; i++) {
		...
		if (!celdas[ numeroAleratorioFilas ][ numeroAleratorioColumnas ].obtenerEstaCeldaTieneUnaBomba()) {
...
public void elegirCelda(int cordenadaX, int cordenadaY) throws Exception,IndexOutOfBoundsException, IllegalAccessException,TocasteUnaBombaExcepcion {
	...
	if (!celdas[cordenadaX][cordenadaY].obtenerEstaCeldaTieneUnaBomba()) {
		if (celdas[cordenadaX][cordenadaY].obtenerBombasAlRededorDeEstaCelda() == 0) {
 ...
 */
private static void buscarTodosLosCerosEncerrados(Celdas[][] celdas, int cordenadaX, int cordenadaY){
	celdas[cordenadaX][cordenadaY].verCelda();
	...
	if (xEsValidoArriba && !celdas[cordenadaX+1][cordenadaY].haSidoVista() && celdas[cordenadaX+1][cordenadaY].obtenerBombasAlRededorDeEstaCelda() == 0) {
	...
	if (xEsValidoAbajo && !celdas[cordenadaX-1][cordenadaY].haSidoVista() && celdas[cordenadaX-1][cordenadaY].obtenerBombasAlRededorDeEstaCelda() == 0) {
		buscarTodosLosCerosEncerrados(celdas,cordenadaX-1,cordenadaY);
	}
	if (xEsValidoAbajo && !celdas[cordenadaX-1][cordenadaY].haSidoVista() && celdas[cordenadaX-1][cordenadaY].obtenerBombasAlRededorDeEstaCelda() != 0) {
		celdas[cordenadaX-1][cordenadaY].verCelda();
	...
	if (yEsValidoIzquierda && !celdas[cordenadaX][cordenadaY-1].haSidoVista() && celdas[cordenadaX][cordenadaY-1].obtenerBombasAlRededorDeEstaCelda() == 0) {
	...
	if (yEsValidoDerecha && !celdas[cordenadaX][cordenadaY+1].haSidoVista() && celdas[cordenadaX][cordenadaY+1].obtenerBombasAlRededorDeEstaCelda() == 0) {
		buscarTodosLosCerosEncerrados(celdas,cordenadaX,cordenadaY+1);
	}
	if (yEsValidoDerecha && !celdas[cordenadaX][cordenadaY+1].haSidoVista() && celdas[cordenadaX][cordenadaY+1].obtenerBombasAlRededorDeEstaCelda() != 0) {
		celdas[cordenadaX][cordenadaY+1].verCelda();
	...
	if (xyEsValidoArribaIzquierda && !celdas[cordenadaX+1][cordenadaY-1].haSidoVista() && celdas[cordenadaX+1][cordenadaY-1].obtenerBombasAlRededorDeEstaCelda() == 0) {
		buscarTodosLosCerosEncerrados(celdas,cordenadaX+1,cordenadaY-1);
	}
	if (xyEsValidoArribaIzquierda && !celdas[cordenadaX+1][cordenadaY-1].haSidoVista() && celdas[cordenadaX+1][cordenadaY-1].obtenerBombasAlRededorDeEstaCelda() != 0) {
		celdas[cordenadaX+1][cordenadaY-1].verCelda();
	}

	if (xyEsValidoArribaDerecha && !celdas[cordenadaX+1][cordenadaY+1].haSidoVista() && celdas[cordenadaX+1][cordenadaY+1].obtenerBombasAlRededorDeEstaCelda() == 0) {
		buscarTodosLosCerosEncerrados(celdas,cordenadaX+1,cordenadaY+1);
	}
	if (xyEsValidoArribaDerecha && !celdas[cordenadaX+1][cordenadaY+1].haSidoVista() && celdas[cordenadaX+1][cordenadaY+1].obtenerBombasAlRededorDeEstaCelda() != 0) {
		celdas[cordenadaX+1][cordenadaY+1].verCelda();
	...
	if (xyEsValidoAbajoIzquierda && !celdas[cordenadaX-1][cordenadaY-1].haSidoVista() && celdas[cordenadaX-1][cordenadaY-1].obtenerBombasAlRededorDeEstaCelda() == 0) {
		buscarTodosLosCerosEncerrados(celdas,cordenadaX-1,cordenadaY-1);
	}
	if (xyEsValidoAbajoIzquierda && !celdas[cordenadaX-1][cordenadaY-1].haSidoVista() && celdas[cordenadaX-1][cordenadaY-1].obtenerBombasAlRededorDeEstaCelda() != 0) {
		celdas[cordenadaX-1][cordenadaY-1].verCelda();
	...
	if (xyEsValidoAbajoDerecha && !celdas[cordenadaX-1][cordenadaY+1].haSidoVista() && celdas[cordenadaX-1][cordenadaY+1].obtenerBombasAlRededorDeEstaCelda() == 0) {
		buscarTodosLosCerosEncerrados(celdas,cordenadaX-1,cordenadaY+1);
	}
	if (xyEsValidoAbajoDerecha && !celdas[cordenadaX-1][cordenadaY+1].haSidoVista() &&   celdas[cordenadaX-1][cordenadaY+1].obtenerBombasAlRededorDeEstaCelda() != 0) {
		celdas[cordenadaX-1][cordenadaY+1].verCelda();
...
private void asignarNumeroDeBombasAledañas(int cordenadaX, int cordenadaY){
	...
	if (xEsValidoArriba && !celdas[cordenadaX+1][cordenadaY].obtenerEstaCeldaTieneUnaBomba()) {
		celdas[cordenadaX+1][cordenadaY].aumentarBombasAlRededorDeEstaCelda();
	}
	if (xEsValidoAbajo && !celdas[cordenadaX-1][cordenadaY].obtenerEstaCeldaTieneUnaBomba()) {
		celdas[cordenadaX-1][cordenadaY].aumentarBombasAlRededorDeEstaCelda();
	}
	if (yEsValidoIzquierda && !celdas[cordenadaX][cordenadaY-1].obtenerEstaCeldaTieneUnaBomba()) {
		celdas[cordenadaX][cordenadaY-1].aumentarBombasAlRededorDeEstaCelda();
	}
	if (yEsValidoDerecha && !celdas[cordenadaX][cordenadaY+1].obtenerEstaCeldaTieneUnaBomba()) {
		celdas[cordenadaX][cordenadaY+1].aumentarBombasAlRededorDeEstaCelda();
	}
	if (xyEsValidoArribaIzquierda && !celdas[cordenadaX+1][cordenadaY-1].obtenerEstaCeldaTieneUnaBomba()) {
		celdas[cordenadaX+1][cordenadaY-1].aumentarBombasAlRededorDeEstaCelda();
	}
	if (xyEsValidoArribaDerecha && !celdas[cordenadaX+1][cordenadaY+1].obtenerEstaCeldaTieneUnaBomba()) {
		celdas[cordenadaX+1][cordenadaY+1].aumentarBombasAlRededorDeEstaCelda();
	}
	if (xyEsValidoAbajoIzquierda && !celdas[cordenadaX-1][cordenadaY-1].obtenerEstaCeldaTieneUnaBomba()) {
		celdas[cordenadaX-1][cordenadaY-1].aumentarBombasAlRededorDeEstaCelda();
	}
	if (xyEsValidoAbajoDerecha && !celdas[cordenadaX-1][cordenadaY+1].obtenerEstaCeldaTieneUnaBomba()) {
		celdas[cordenadaX-1][cordenadaY+1].aumentarBombasAlRededorDeEstaCelda();
	}
}
